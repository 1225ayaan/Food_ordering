  ...
  <div class="modal fade" id="uni_modal_right" role='dialog'>
    <div class="modal-dialog modal-full-height  modal-md" role="document">
      ...
      <div class="modal-body">
        ...
        <div class="container"><div class="small text-center text-muted">Copyright © 2024 - Ayaan Jahagirdar | <a href="https://www.sourcecodester.com/" target="_blank">Sourcecodester</a></div></div>
        </footer>
...
// }
?>
To integrate a chatbot into your food ordering system using an iframe, you can follow these steps:

1. Create a button that, when clicked, will display the chatbot.
2. Align the button to the right side of the page.
...
<html lang="en">
    ...
    <style>
      ...
      /* Align the chatbot button to the right side */
      .chatbot-button {
          position: fixed;
          bottom: 20px;
          right: 20px;
...
<div class="modal fade" id="confirm_modal" role='dialog'>
  ...
  <!-- Chatbot Button -->
  <button class="btn btn-primary chatbot-button" onclick="toggleChatbot()">Chat with us</button>
  <!-- Chatbot iframe -->
  <iframe id="chatbot-iframe" src="https://webchat.botframework.com/embed/foodordering-bot?s=uqYhrL3nyOg.Y85X_06gLITwGAg1o2JJNd9TWcCdwqUdtwTrf1p-W8E" style="display: none; height: 502px; max-height: 502px;"></iframe>
